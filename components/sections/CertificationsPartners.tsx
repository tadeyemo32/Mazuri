...
export default function CertificationsPartners() {
  return (
    <section className="border-y border-white/10 bg-[var(--color-bg-elevated)] py-4 md:py-5">
      <div className="container mx-auto px-6 max-w-7xl">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6 md:gap-8">
          <div>
            ...
            <ul className="flex flex-wrap gap-x-6 gap-y-1 text-sm font-medium text-[var(--color-text)]">
